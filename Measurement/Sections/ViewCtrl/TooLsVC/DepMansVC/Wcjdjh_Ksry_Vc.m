...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cellIdentifier = @"Wcjdjh_ksry_Cell";
    Wcjdjh_ksry_Cell *cell = (Wcjdjh_ksry_Cell*)[tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Wcjdjh_ksry_Model *model = self.m_dataSourceArr[indexPath.row];
