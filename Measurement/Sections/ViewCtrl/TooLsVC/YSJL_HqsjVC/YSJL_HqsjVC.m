...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.selectedDelegate respondsToSelector:@selector(SelectValue_YSJL_HqsjVC:DidSelectedValue:)]) {
        [self.selectedDelegate SelectValue_YSJL_HqsjVC:self DidSelectedValue:@"ds"];
    }
}
/*
 //设置cell的行高
