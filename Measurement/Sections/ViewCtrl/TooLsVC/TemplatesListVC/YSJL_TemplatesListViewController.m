//
//  YSJL_TemplatesListViewController.m
//  Measurement
//
...
@interface YSJL_TemplatesListViewController ()
...
@implementation YSJL_TemplatesListViewController
...
- (IBAction)OKBtnClick:(id)sender {
    ...
    [self dismissViewControllerAnimated:YES completion:^(void){
        if ([self.m_delegate respondsToSelector:@selector(YSJL_TemplatesListVC:didSelectedOKByObj:)]) {
            [self.m_delegate YSJL_TemplatesListVC:self didSelectedOKByObj:self.data];
        }
    }];
