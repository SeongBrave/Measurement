//
//  CYTextFieldAutoFillInputView.m
//  BedsNursingApp
//
...
@interface CYTextFieldAutoFillInputView () <UIInputViewAudioFeedback, UITableViewDataSource, UITableViewDelegate>

@property (assign, nonatomic) CYTextField *textField;
@property (strong, nonatomic) UIImageView *keyboardImageView;
@property (strong, nonatomic) UITableView *tableView;

@end

@implementation CYTextFieldAutoFillInputView
