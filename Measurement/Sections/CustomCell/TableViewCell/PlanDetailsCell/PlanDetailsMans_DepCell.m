...
@interface PlanDetailsMans_DepCell ()

@property(nonatomic , strong)ks_Model *m_model;

@end

@implementation PlanDetailsMans_DepCell
...
- (IBAction)selectMansClick:(id)sender {
    ...
    if ([self.m_mans_DepDelegate respondsToSelector:@selector(planDetailsMans_DepCell:didSelectedWithks_Model:)]) {
        [self.m_mans_DepDelegate planDetailsMans_DepCell:self didSelectedWithks_Model:_m_model];
    }
}
